      ...
      <div className='w-[100%] flex flex-col md:flex-row justify-evenly'>
        <span>
          <div className='labels flex flex-col md:gap-10 mb-3 md:mb-0 font-bold md:p-2 text-xl'>
            <label htmlFor='taskInput'>Todo List</label>
            <label className='hidden md:block' htmlFor='taskDescription'>Todo Description</label>
          </div>
        </span>
        <span className='md:w-[70%] w-[100%]'>
          <div className='inputs flex flex-col gap-5'>
            <input
              ...
              onChange={(e) => setTaskInputValue(e.target.value)} placeholder='Enter todo'
            />

            <label className='font-bold md:hidden text-xl' htmlFor='taskDescription'>Todo Description</label>
            ...
            <input
              ...
              onChange={(e) => setTaskDescInputValue(e.target.value)} placeholder='Enter todo description'
            />
          </div>
        </span>
      </div>
    ...
    <Fragment key={index}>
      <div className='mx-auto my-2 flex flex-col md:flex-row gap-2 w-[70%] bg-blue-500 text-lg text-white p-2 rounded-lg hover:border-1 dark:border-white border-black hover:shadow-[0px_3px_6px_rgba(0,0,0,0.16),0px_3px_6px_rgba(0,0,0,0.23)] transition duration-300'>
        <span className='w-[85%] flex flex-col'>
          <span className='font-bold'>Sl no. : {index + 1}</span>
          <span><span className='font-bold'>Todo List</span> : {element.task}</span>
          <span><span className='font-bold'>Todo Description</span> : {element.description}</span>
        </span>
